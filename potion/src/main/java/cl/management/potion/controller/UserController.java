...
public class UserController {
  ...
  public ResponseEntity<Object> listUsers(
      ...
      @RequestParam(required = true) Integer page) throws ServiceException {
    return ResponseEntity.ok().body(service.listUsers(PageRequest.of(page, size)));
  }
  ...
  public ResponseEntity<DefaultResponse> searchUser(
    ...
    return ResponseEntity.ok().body(service.searchUser(username));
  }
